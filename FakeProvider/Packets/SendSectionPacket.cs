...
namespace FakeProvider
{
    class SendSectionPacket
    {
		...
		{
			using (Ionic.Zlib.DeflateStream deflateStream = new Ionic.Zlib.DeflateStream(writer.BaseStream, 0, true))
            {
        ...
        private static void _CompressTileBlock_Inner(IEnumerable<TileProvider> providers,
			BinaryWriter writer, int xStart, int yStart, int width, int height)
		{
